...
interface PengumumanProps {
  // Add your type definitions for the component props here
  page: (data: string) => void;
}

const Pengumuman: React.FC<PengumumanProps> = ({page}) => {
    ...
    <div className="p-10 bg-white rounded shadow-md">
      ...
      <div className="my-10 p-4 bg-[#794422] rounded shadow-md transform transition-transform duration-300 hover:scale-105 w-full flex flex-col items-center">
        ...
        <div className="flex justify-center space-x-4">
          <a href="#" onClick={handleClick} className="text-xl font-bold mb-2 bg-white text-[#794422] my-10 py-2 px-10 rounded-full transform transition-transform duration-300 hover:scale-105">Pesan Sekarang</a>
